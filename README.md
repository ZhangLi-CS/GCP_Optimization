...
This is an code implementation of CVPR2020 paper ([What Deep CNNs Benefit from Global Covariance Pooling: An Optimization Perspective]()), created by [Qilong Wang](https://csqlwang.github.io/homepage/) and Li Zhang.
...
the setting of lr in each original paper.
