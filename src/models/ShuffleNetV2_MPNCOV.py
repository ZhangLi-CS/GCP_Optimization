...
class ShuffleNetV2_MPNCOV(nn.Module):
    def __init__(self, stages_repeats, stages_out_channels, num_classes=1000):
        ...
        self.dimension_reduction = nn.Sequential(
            nn.Conv2d(self._stage_out_channels[-1], 256 , kernel_size=1, stride=1,padding = 0, bias=False),
            nn.BatchNorm2d(256),
...
def shufflenet_v2_mpncov_x0_5(pretrained=False, progress=True, **kwargs):
    return _shufflenetv2_mpncov('shufflenetv2_mpncov_x0.5', pretrained, progress,
                         [4, 8, 4], [24, 48, 96, 192, 1024], **kwargs)


def shufflenet_v2_mpncov_x1_0(pretrained=False, progress=True, **kwargs):
    return _shufflenetv2_mpncov('shufflenetv2_mpncov_x1.0', pretrained, progress,
                         [4, 8, 4], [24, 116, 232, 464, 1024], **kwargs)


def shufflenet_v2_mpncov_x1_5(pretrained=False, progress=True, **kwargs):
    return _shufflenetv2_mpncov('shufflenetv2_mpncov_x1.5', pretrained, progress,
                         [4, 8, 4], [24, 176, 352, 704, 1024], **kwargs)


def shufflenet_v2_mpncov_x2_0(pretrained=False, progress=True, **kwargs):
    return _shufflenetv2_mpncov('shufflenetv2_mpncov_x2.0', pretrained, progress,
