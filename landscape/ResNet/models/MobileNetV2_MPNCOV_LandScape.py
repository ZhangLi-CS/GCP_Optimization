...
class MobileNetV2_MPNCOV_LandScape(nn.Module):
    def __init__(self, num_classes=1000, width_mult=1.0):
        super(MobileNetV2_MPNCOV_LandScape, self).__init__()
...
def mobilenet_v2_mpncov_landscape(pretrained=False, **kwargs):
    return MobileNetV2_MPNCOV_LandScape(**kwargs)
